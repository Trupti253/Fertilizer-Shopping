...
<section class="search-form">
   ...
   <form action="" method="POST">
      <input type="text" class="box" name="search_box" placeholder="उत्पादों की खोज करें...">
      <input type="submit" name="search_btn" value="खोजें" class="btn">
   </form>
...
<section class="products" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
         ...
         echo '<p class="empty">कोई परिणाम नहीं मिला!</p>';
      }
